...
- Budget guardrail: CAD 50 monthly budget on `kani-network-sandbox`, with 50%, 80%, and 100% thresholds
...
This means the GKE pilot can likely run through the 90-day trial from a credit-burn perspective, but the current CAD 50 budget alert is intentionally tighter than the estimated gross monthly run rate.

## Recommendation

Recommended decision:

- Keep GKE running for a short observation window of 24-72 hours.
- If validator behavior is stable and you want longer testing, raise the budget guardrail from CAD 50 to CAD 100 for the month or accept that it may alert.
