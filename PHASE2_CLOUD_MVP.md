...
The smoke test exercises the JSON payment endpoint, the ISO 20022 `pacs.008` endpoint, the ISO 20022 `pacs.002` status endpoint, and the ISO 20022 `camt.053` account statement endpoint against a fresh sandbox test asset.
